package com.example.project97.controller;
...
import com.example.project97.service.PaymentService;
...
//    public ResponseEntity<Payment> updatePerson(@PathVariable(value = "id") Long id, @RequestBody Payment paymentDetails{
